...
export const SubscriptionPlanCard: React.FC<SubscriptionPlanCardProps> = ({
  ...
  const getBgColor = () => {
    switch (plan.id) {
      ...
      case 'enterprise': return '#836EF9'  // Monad Purple for premium
  ...
  return (
    ...
    >
      ...
      <div
        className="p-8 h-full transition-all duration-300 hover:shadow-lg cursor-pointer"
        style={{
      ...
      >
        ...
        <div className="mb-8">
          <div className="flex items-baseline">
            ...
            <span className="text-gray-600 ml-3 text-xl font-bold">/{plan.durationText || `${plan.duration}s`}</span>
          </div>
        </div>
